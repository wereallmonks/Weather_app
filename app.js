...
const api_url = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=e827cc18a30d7b0beb99903a8635c4d2`
...
console.log(location, icon, description, temp, humidity,speed)
});
